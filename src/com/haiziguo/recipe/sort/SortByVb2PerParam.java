...
public class SortByVb2PerParam implements Comparator<Object>{
	...
	public int compare(Object o1, Object o2) {
		 Food s1 = (Food) o1;
		 Food s2 = (Food) o2;
		 if(s1.getVb2()<Define.FLOAT_ZERO || s2.getVb2()<Define.FLOAT_ZERO){
			 	if(order)
		 ...
		 switch(param){
		 	...
		 	case 11:
		 		if(order)
		 			return ((Float)(s1.getVb2()/s1.getVe())).compareTo(((Float)(s2.getVb2()/s2.getVe())));
		 		else
		 			return ((Float)(s2.getVb2()/s2.getVe())).compareTo(((Float)(s1.getVb2()/s1.getVe())));
		 	case 12:
		 		if(order)
		 			return ((Float)(s1.getVb2()/s1.getNa())).compareTo(((Float)(s2.getVb2()/s2.getNa())));
		 		else
		 			return ((Float)(s2.getVb2()/s2.getNa())).compareTo(((Float)(s1.getVb2()/s1.getNa())));
		 	case 9:
		 	default:
		 		if(order)
		 			return s1.getVb2().compareTo(s2.getVb2());
